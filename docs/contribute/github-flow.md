...
<!-- Title: Contributing GithubFlow FlutterSample -->
<!-- Label: FlutterSample -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to flutter-sample project on [GitHub](https://github.com/luismayta/flutter-sample), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/flutter-sample/pulls).
...
To follow the instructions in this guide and start contributing to flutter-sample project on GitHub:
...
```bash
git remote add upstream  https://github.com/luismayta/flutter-sample.git
```

Now your **upstream** points to **luismayta/flutter-sample**.
...
git fetch upstream # assuming upstream is luismayta/flutter-sample
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/flutter-sample/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
